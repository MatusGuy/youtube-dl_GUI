...
"download!"))
        ...
        self.ExportTypeLabel.setText(_translate("MainWindow", "Export"))
        ...
        self.RangeInput.setToolTip(_translate("MainWindow", "<html><head/><body><p>Select the range for download. </p><p>• <span style=\" font-weight:600;\">\'\' </span>Leave empty to download all</p><p>• <span style=\" font-weight:600;\">m-n </span>Download from specified range</p><p>•<span style=\" font-weight:600;\"> 1,2,..n </span>Download selected items</p><p>• <span style=\" font-weight:600;\">x,m-n,y,z</span> Download specific item and ranges</p></body></html>"))
